    ...
    <main class="main-container">
        <center>
            <div class="main-title">
                <p class="font-weight-bold">View Course</p>
            </div>
            <table border="1">
                <tr>
                    <th>Course Name</th>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo "{$info['seat']}"; ?></td>
                        <td><?php echo "{$info['department']}"; ?></td>
                        <td><?php echo "{$info['sem']}"; ?></td>
                        <td><?php echo "{$info['description']}"; ?></td>
                        <td><?php echo "<a class='btn btn-danger' onclick=\"javascript:return confirm('Are you sure to delete the entry?');\" href='view_course.php?course_id={$info['id']}'>Delete</a>"; ?></td>
